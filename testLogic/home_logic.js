...
exports.index = function (request, response) {
    var wrap = {},
        step,
        html;
    step = new Step(3, function () {
        //渲染最终结果
        console.log(wrap);
        html = viewManager.view("test/nxl_box").handle(wrap);
        //缓存
    ...
    (function () {
        handle = viewManager.view("home/nxl_top").handle;
        wrap.nxlTop=handle();
        step.over();
    })();
    (function () {
        handle = viewManager.view("home/nxl_left").handle;
        wrap.nxlLeft=handle();
        step.over();
    })();
    (function () {
        handle = viewManager.view("home/nxl_right").handle;
        wrap.nxlRight=handle();
        step.over();
    })();
    /*//获取cookie;
    var Cookies = {};
